...
function Login() {
  return (
    ...
    <div class="flex max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-xl dark:bg-gray-800 lg:max-w-4xl my-20 p-10">
        <div class="hidden bg-cover lg:block lg:w-1/2 rounded-lg" style={{backgroundImage:'url("https://images.unsplash.com/photo-1606660265514-358ebbadc80d?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1575&q=80")'}}></div>
        ...
        <div class="w-full px-6 py-8 md:px-8 lg:w-1/2">
            ...
            <a href="f" class="flex items-center justify-center mt-4 text-gray-600 transition-colors duration-200 transform border rounded-lg dark:border-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                <div class="px-4 py-2">
            ...
            <div class="mt-4">
                ...
                <a href="f" class="text-xs text-gray-500 dark:text-gray-300 hover:underline">Forget Password?</a>
            </div>
            ...
            <Link to={'/signup'} className="mt-5 btn btn-link w-full mx-auto">Sign Up here</Link>
        </div>
    </div>
  )
}
