  ...
  return (
    ...
    <div class="flex max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-xl dark:bg-gray-800 lg:max-w-4xl my-20 p-10">
        ...
        <div class="w-full px-6 py-8 md:px-8 lg:w-1/2">
            ...
            <Link to={'/login'} className="mt-5 btn btn-link w-full mx-auto">Log In here</Link>
        </div>

        <div class="hidden bg-cover rounded-lg lg:block lg:w-1/2" style={{backgroundImage:'url("https://images.unsplash.com/photo-1606660265514-358ebbadc80d?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1575&q=80")'}}></div>
